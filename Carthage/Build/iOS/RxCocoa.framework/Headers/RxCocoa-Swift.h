...
/// Typed parent object.
@property (nonatomic, readonly, weak) UICollectionView * __nullable collectionView;
...
/// Typed parent object.
@property (nonatomic, readonly, weak) UIScrollView * __nullable scrollView;
...
/// Typed parent object.
@property (nonatomic, readonly, weak) UITextView * __nullable textView;
...
/// </code>.
- (RxCollectionViewDataSourceProxy * __nonnull)rx_createDataSourceProxy;
...
/// \returns  Instance of delegate proxy that wraps <code>dataSource
/// </code>.
- (RxTableViewDataSourceProxy * __nonnull)rx_createDataSourceProxy;
